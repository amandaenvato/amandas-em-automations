...
2. **Step 2: Fetch Information from Sources** (see details below)
3. **Step 3: Generate Wins Report** (see details below)
...
## Step 2: Fetch Information from Sources
...
**Output:** `files/output/sprint-report-02-02-2026/OUTPUT.md` with formatted wins report
